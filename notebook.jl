...
using LaTeXStrings, Plots, Random, Images, PlutoUI
...
!!! note "Sistemas Ópticos"
	Los sistemas ópticos son cualquier ccombinación de 
...
Las señales pueden desplazarse. El desfase temporal de una señal $x(t)$ en una cantidad $\tau$ es una operación muy frecuente en el procesamiento de señales. Para esto podemos ocupar el siguiente operador, el cual se aplica a una función $\varphi$:

!!! alert "Operador desfase"
	$$\tau_a \{\varphi\}(t) = \tau_a \varphi(t) = \varphi(t-a) \;\; a \in \mathbb{R}$$

El desfase de una señal $x(t)$ en una cantidad $a$ se define como:

!!! note "Definición de desplazamiento o desfase"
	$$y(t) = x(t-a) = \tau_a x(t)$$
con $a \in \mathbb{R}$. La señal $x(t)$ se

* mueve hacia la derecha (*retrasa*) para $a > 0$
* mueve hacia la izquierda (*adelanta*) para $a < 0$
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "381359a2998d55a64c3eae2071184de451e4330e"
